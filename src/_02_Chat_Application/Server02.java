...
boolean b = true;
	...
	public void run() {
		...
		while (b) {
				...
				String x = JOptionPane.showInputDialog("Place your message here");
				obj.writeUTF(x);
		...
		JOptionPane.showMessageDialog(null, "The computer has found a SocketTimeoutExcpetion. Meeting over.");
		b = false;
			...
			JOptionPane.showMessageDialog(null, "The computer has found a IOException. Meeting over.");
			b = false;
		}
